...
<div class="project-card">
  ...
  <div class="project-header">
    ...
    <span class="project-period">2021-now</span></h3>

    <p>An AdTech & SaaS product built from scratch in Türkiye and scaled globally as “Global Joker,” now serving 50+ markets under localized brand names (Yemeksepeti, Talabat, Foodpanda, PedidosYa).</p>
  ...
  <div class="project-images">
    <img src="./joker.jpg" alt="Joker screenshot" class="project-image">
    <img src="./joker-2.jpg" alt="Joker secondary" class="project-image">
  </div>
</div>
...
<span class="project-period">2025</span></h3>
    <p>Retro-style shooter game developed in PICO-8 fantasy console, featuring classic arcade gameplay.</p>
    <ul>
...
<span class="project-period">2019-2025</span></h3>
    <p>Collection of REST APIs built for technical assessments and take-home assignments, demonstrating various architectural patterns and technologies.</p>
    <ul>
    ...
    <p class="tech-stack"><strong>Tech Stack:</strong> Python, Node.js, .NET, Golang, React, TypeScript, Docker</p>
    <p class="github-link">Employee HR Profile, Flask + React: <a href="https://github.com/ata-o/employee">View on GitHub</a></p>
    <p class="github-link">KrakenClient, Node.js + Typescript: <a href="https://github.com/ata-o/krakenclient">View on GitHub</a></p>
    <p class="github-link">Creosafe, Node.js + React + Graphql: <a href="https://github.com/ata-o/safe-app">View on GitHub</a></p>
</div>
</div>
...
<span class="project-period">2019-2021</span></h3>
    <p>Microservice-based enterprise SaaS platform developed at BITES, including multiple products: XperLMS (SCORM-compliant learning management system), XperPay (payment gateway integrated with Iyzico), and XperDrive (end-to-end encrypted file management system).</p>
    <ul>
    ...
    <p class="tech-stack"><strong>Tech Stack:</strong> .NET Core 3.1, Django, PostgreSQL, RabbitMQ, Vue.js, Docker, AWS, gRPC</p>
    <div class="project-images">
    <img src="./xpermeet-1.jpg" alt="BizBize screenshot" class="project-image">
    <img src="./xpermeet-2.jpg" alt="BizBize secondary" class="project-image">
  </div>
</div>
</div>
...
<span class="project-period">2020</span></h3>
    <p>Computer vision system for automated aircraft detection and cataloging from aerodrome surveillance imagery, developed for defense sector applications.</p>
    <ul>
    ...
    <p class="tech-stack"><strong>Tech Stack:</strong> Python, TensorFlow, YOLOv3, COCO Dataset</p>
</div>
</div>
...
<span class="project-period">2020-2021</span></h3>
    <p>Enterprise supplier management platform for defense industry supply chain optimization, handling evaluation, scoring, and analytics for thousands of suppliers.</p>
    <ul>
    ...
    <p class="tech-stack"><strong>Tech Stack:</strong> Django, RabbitMQ, Vue.js, PostgreSQL</p>
</div>
</div>
...
<span class="project-period">2019-2021</span></h3>
    <p>Immersive virtual presence sandbox for military professionals supporting collaborative operations planning on Oculus Rift S and Quest.</p>
    <ul>
    ...
    <p class="tech-stack"><strong>Tech Stack:</strong> Unity, Oculus SDK, HLSL/Cg, gRPC, SWORD (MASA)</p>
</div>
</div>
...
<span class="project-period">2018-2019</span></h3>
    <p>Full-stack Uber/Lyft clone built from scratch as senior project, featuring real-time ride matching, GPS tracking, and payment processing.</p>
    <ul>
    ...
    <p class="tech-stack"><strong>Tech Stack:</strong> Node.js, React Native, Mocha</p>
    <p class="github-link"><a href="https://github.com/ata-o/riders-on-the-storm" target="_blank">View on GitHub</a></p>
</div>
</div>
...
<span class="project-period">2018-2019</span></h3>
    <p>Immersive 3D museum experience showcasing Turkish cultural heritage. Awarded TÜBİTAK 2209-B Research Grant in 2019.</p>
    <ul>
    ...
    <p class="tech-stack"><strong>Tech Stack:</strong> Unity3D, C#, JIRA, Git</p>
    <p class="github-link"><a href="https://github.com/ata-o/museumcorvus" target="_blank">View on GitHub</a></p>
</div>
</div>
...
<span class="project-period">2019</span></h3>
    <p>Mobile game developed during job search period, featuring simple mechanics and addictive gameplay loop.</p>
    <ul>
    ...
    <p class="tech-stack"><strong>Tech Stack:</strong> Unity, C#</p>
    <p class="github-link"><a href="https://github.com/ata-o/Move-The-Fan" target="_blank">View on GitHub</a></p>
</div>
</div>
...
<span class="project-period">2020</span></h3>
    <p>Real-time weather checking bot for Discord servers, providing current weather information and forecasts.</p>
    <ul>
    ...
    <p class="tech-stack"><strong>Tech Stack:</strong> [Python/Node.js]</p>
    <p class="github-link"><a href="https://github.com/ata-o/silivribot" target="_blank">View on GitHub</a></p>
</div>
</div>